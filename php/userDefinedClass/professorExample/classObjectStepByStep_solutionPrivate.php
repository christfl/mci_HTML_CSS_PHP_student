...
//instance new
$professorList[]=new professor("Eric","Christof");
...
//updating a private property : lastname
//$professorList[0]->lastname="Christoffel";
//use a setter fct
$professorList[0]->setProfessorLastname('Christoffel');

//array element 0 is an object displayed as an HTML content
//arrow notation for OOPHP -> (and not dot . notation!)
//reading a private property => use getter fct!
...
//class method
    ...
    public function setProfessorLastname($lastname){
        $this->lastname=$lastname;
    }
